...
Testimonials: http://localhost:3000/dashboard/testimonials ⭐ NEW
📚 API Documentation
Base URL
...
🎨 Testimonials System
How It Works
User Records Video → Video recording page (/record/:campaignId)
Video Uploads to Cloudinary → POST /video/upload
Testimonial Created Automatically → Backend creates entry in DB
Appears in Dashboard → /dashboard/testimonials
Testimonial Schema
{
...
3
@DhruvilCG
DhruvilCG Dhruvil Patel
@Jeevan-2275
Jeevan-2275 Jeevan Kadam
@kiranchaudhary18
kiranchaudhary18 Kiran Dekaliya
Languages
JavaScript
98.7%
